...
namespace BeLightBible
{
    public class Versiculo
    {
        ...
        private static readonly Dictionary<string, int> livrosCapitulos = new Dictionary<string, int>
        {
        ...
        { "Cantares", 8 }, { "Isaías", 66 }, { "Jeremias", 52 }, { "Lamentações", 5 }, { "Ezequiel", 48 },
        { "Daniel", 12 }, { "Oséias", 14 }, { "Joel", 3 }, { "Amós", 9 }, { "Abadias", 1 }, { "Jonas", 4 },
        ...
        public static int GetNumeroDeCapitulos(string livro)
        {
            if (livrosCapitulos.ContainsKey(livro))
            {
                return livrosCapitulos[livro];
            }

            return 0;
        }

        public static List<string> GetTodosOsLivros()
        {
            return new List<string>(livrosCapitulos.Keys);
        }
    }
}
